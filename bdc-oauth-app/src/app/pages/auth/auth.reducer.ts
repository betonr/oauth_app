...
export const reducer = createReducer(initialState,
  on(Login, (state, payload) => {
    ...
    document.cookie = "oauth.dpi.inpe.br="+payload['token'].toString()+"; Domain=.inpe.br; path=/";
    return { 
      ...state,
  ...
  on(Logout, (state) => {
    ...
    document.cookie = "oauth.dpi.inpe.br=''; Domain=.inpe.br; expires="+(new Date()).toDateString()+"; path=/";
